...
import com.devsuperior.bds04.entities.dto.EventDTO;
...
public class EventControllerIT {
	...
	public void insertShouldReturn422WhenAdminLoggedAndBlankName() throws Exception {
		...
		result.andExpect(jsonPath("$.errorsList[0].fieldName").value("name"));
		result.andExpect(jsonPath("$.errorsList[0].message").value("Campo requerido"));
	}
	...
	public void insertShouldReturn422WhenAdminLoggedAndPastDate() throws Exception {
		...
		result.andExpect(status().isUnprocessableEntity());
		result.andExpect(jsonPath("$.errorsList[0].fieldName").value("date"));
		result.andExpect(jsonPath("$.errorsList[0].message").value("A data do evento não pode ser passada"));
	}
	...
	public void insertShouldReturn422WhenAdminLoggedAndNullCity() throws Exception {
		...
		result.andExpect(status().isUnprocessableEntity());
		result.andExpect(jsonPath("$.errorsList[0].fieldName").value("cityId"));
		result.andExpect(jsonPath("$.errorsList[0].message").value("Campo requerido"));
	}
